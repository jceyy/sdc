...
int RBCServer::Send(NetUserInput *data) {
...
//m change
	...
	//m change
	//cout << "Simulation : Received "<<counter<<" packets."<<endl;
...
int RBCClient::Receive(void *outData,ReqType reqType, uRequest::ImgType imgType, unsigned short resReq=0) { //ReqType
